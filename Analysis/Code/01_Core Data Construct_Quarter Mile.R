#This create the main repeat sales dataset with the 1/4 mile buffer
...
load("./Build/Output/core_1320.RData")    #core2 for 1/4 mile buffers
...
#Difference between sales of properties.
  ...
  save (rs_core1.4, file="./Analysis/Input/Core14.RData")
